...
const Home = () => {
  ...
  const banners = [
    { 
      id: 1, 
      title: 'Welcome Bonus', 
      subtitle: `Get 100% up to 5,000 ${currency}`, 
    ...
    { 
      ...
      subtitle: `Win up to 100,000 ${currency}`, 
      ...
      <div className="flex items-center justify-center min-h-[50vh]">
        <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-6 max-w-md w-full text-center">
          ...
          <button 
            ...
            className="mt-4 px-6 py-2 bg-primary-500 text-dark-900 rounded-lg hover:bg-primary-400 transition"
          >
            Retry
          </button>
        </div>
  ...
  return (
    <div className="w-full">
      {/* Banner Carousel */}
      <motion.div 
        className="w-full mb-6 -mx-4 px-4"
      ...
      >
        <Swiper 
          ...
          effect="fade" 
          className="banner-height rounded-2xl overflow-hidden shadow-2xl"
        >
          {banners.map((b) => (
