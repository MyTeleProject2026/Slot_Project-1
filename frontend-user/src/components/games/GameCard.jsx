  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4] bg-gradient-to-br from-dark-900 to-dark-800 overflow-hidden">
        ...
        {/* Play button overlay */}
        <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex items-center justify-center transition-all duration-300 ${
      ...
      <div className="p-2.5">
        <h3 className="text-sm font-semibold truncate text-white">{game.name}</h3>
