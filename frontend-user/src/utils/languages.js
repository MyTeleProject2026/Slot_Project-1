...
export const translations = {
  [LANGUAGES.EN]: {
    ...
    'deposit.minAmount': 'Minimum deposit: 100 {{currency}}',
    ...
    'withdraw.minAmount': 'Minimum withdrawal: 500 {{currency}}',
  ...
  [LANGUAGES.MM]: {
    ...
    'deposit.minAmount': 'အနည်းဆုံးသွင်းရန် 100 {{currency}}',
    ...
    'withdraw.minAmount': 'အနည်းဆုံးထုတ်ရန် 500 {{currency}}',
