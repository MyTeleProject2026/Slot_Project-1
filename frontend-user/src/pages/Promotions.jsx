  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <div className="animate-spin w-10 h-10 border-4 border-primary-500/30 border-t-primary-500 rounded-full mx-auto"></div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      >
        ...
        <p className="text-gray-400 mb-6">Exclusive offers and bonuses for our valued players</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {promotions.map((promo, index) => {
            ...
            return (
              ...
              >
                <div className={`h-32 bg-gradient-to-r ${promo.color} flex items-center justify-center relative overflow-hidden`}>
                  ...
                  <Icon className="text-5xl text-white/80 relative z-10 drop-shadow-lg" />
                </div>
                <div className="p-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      {promo.titleTh && (
                        <p className="text-sm text-gray-400">{promo.titleTh}</p>
                      )}
                    </div>
                    <span className={`text-xs px-2 py-0.5 rounded-full ${getTypeColor(promo.type)} border`}>
                      {promo.type}
                    </span>
                  </div>
