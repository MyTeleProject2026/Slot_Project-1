    ...
    const mockPromos = [
      {
        ...
        description: `Get 100% bonus up to 5,000 ${currency} on first deposit`,
        type: 'welcome',
        icon: FaGift,
        color: 'from-purple-600 to-pink-600',
        endDate: '2025-12-31',
        terms: `Minimum deposit 100 ${currency}. Rollover 10x.`,
      },
      {
        id: 2,
      ...
      },
      {
        ...
        description: `Compete with players and win up to 100,000 ${currency}`,
        type: 'tournament',
        icon: FaTrophy,
