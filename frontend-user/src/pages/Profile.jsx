...
const Profile = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 max-w-2xl">
      ...
      >
        <h1 className="text-2xl md:text-3xl font-bold gradient-text mb-6">My Profile</h1>

        <div className="bg-dark-800/80 backdrop-blur-sm rounded-2xl p-6 border border-dark-700/50 shadow-xl">
          {/* Avatar */}
          <div className="flex items-center gap-4 mb-6">
            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-primary-500 to-orange-500 flex items-center justify-center text-3xl font-bold text-dark-900 shadow-lg shadow-primary-500/25">
