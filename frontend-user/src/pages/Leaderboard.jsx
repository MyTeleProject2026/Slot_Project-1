...
const Leaderboard = () => {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setPlayers([
        { rank: 1, name: 'Player1', score: 12500, reward: '5,000 THB' },
        { rank: 2, name: 'Player2', score: 9800, reward: '3,000 THB' },
        { rank: 3, name: 'Player3', score: 8700, reward: '2,000 THB' },
        { rank: 4, name: 'Player4', score: 7600, reward: '1,000 THB' },
        { rank: 5, name: 'Player5', score: 6500, reward: '500 THB' },
      ]);
      setLoading(false);
    }, 1000);
  }, []);
