...
const Home = () => {
  ...
  const banners = [
    { id: 1, title: 'Welcome Bonus', subtitle: `Get 100% up to 5,000 ${currency}`, color: 'from-purple-600 via-pink-600 to-red-600', link: '/promotions', buttonText: 'Claim Now' },
    ...
    { id: 3, title: 'Slot Tournament', subtitle: `Win up to 100,000 ${currency}`, color: 'from-orange-600 via-yellow-600 to-red-600', link: '/games', buttonText: 'Join Now' },
  ];
