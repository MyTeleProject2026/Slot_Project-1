...
export const AdminProvider = ({ children }) => {
  ...
  const getGames = (params = {}) => request('get', '/admin/games', undefined, null, 'Failed to load games', { params });
  ...
  const getDashboardStats = () => request('get', '/admin/dashboard/stats', undefined, null, 'Failed to load dashboard stats');
